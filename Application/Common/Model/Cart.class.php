...
/**
	...
	public function add($id, $productName = null, $num = 1, $price = null, $options = array()) {
		...
		cookie($this->cartName,$data,array('expire'=>$this->lifeTime,'path'=>$this->cookiePath));
		//Cookie::set ( $this->cartName, $data, array('expire'=>$this->lifeTime,'path'=>$this->cookiePath) );
	...
	public function insert($data) {
		...
		cookie($this->cartName,$cartData,array('expire'=>$this->lifeTime,'path'=>$this->cookiePath));
		//Cookie::set ( $this->cartName, $cartData, array('expire'=>$this->lifeTime,'path'=>$this->cookiePath) );
